...
- **Function**: `getInvestmentOverviewAssets()` from `@/utils/investmentApi`
- **Status**: ⚠️ Available but not integrated in main dashboard
...
- **Function**: `getInvestmentOverviewActivity()` from `@/utils/investmentApi`
- **Status**: ⚠️ Available but not integrated in main dashboard
...
- **Status**: ❌ Not implemented in service file
...
- [ ] Investment Performance API (needs implementation)
- [ ] Investment Analytics API (needs implementation)
- [ ] Investment Recommendations API (needs implementation)
